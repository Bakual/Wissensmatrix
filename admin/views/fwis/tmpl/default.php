...
<form action="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=fwis'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<td class="nowrap has-context">
						<div class="pull-left">
							...
							<?php if ($canEdit || $canEditOwn) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&task=fwi.edit&id=' . $item->id);?>" title="<?php echo JText::_('JACTION_EDIT');?>">
