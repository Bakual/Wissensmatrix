 ...
 */
class WissensmatrixModelWbi extends JModelAdmin
{
	/**
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Wbi', $prefix = 'WissensmatrixTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_wissensmatrix.wbi', 'wbi', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_wissensmatrix.edit.wbi.data', array());
