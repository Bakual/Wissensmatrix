 ...
 */
class WissensmatrixModelWbig extends JModelAdmin
{
	/**
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Wbig', $prefix = 'WissensmatrixTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_wissensmatrix.wbig', 'wbig', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_wissensmatrix.edit.wbig.data', array());
