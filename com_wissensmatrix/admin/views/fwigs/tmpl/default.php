...
<form action="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=fwigs'); ?>" method="post" name="adminForm"
	  id="adminForm">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&task=fwig.edit&id=' . $item->id); ?>"
