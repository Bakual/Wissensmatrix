...
<form action="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=wbigs'); ?>" method="post" name="adminForm"
	  id="adminForm">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&task=wbig.edit&id=' . $item->id); ?>"
