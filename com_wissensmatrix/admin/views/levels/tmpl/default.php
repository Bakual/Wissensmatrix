...
<form action="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=levels'); ?>" method="post" name="adminForm"
	  id="adminForm">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&task=level.edit&id=' . $item->id); ?>"
						...
						<td class="center small hidden-phone">
							...
							<?php if ($canEdit || $canEditOwn) : ?>
								&nbsp;<a
									href="index.php?option=com_wissensmatrix&task=level.reset&id=<?php echo $item->id; ?>"><i
