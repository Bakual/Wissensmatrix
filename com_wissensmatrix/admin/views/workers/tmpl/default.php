...
<form action="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=workers'); ?>" method="post"
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&task=worker.edit&id=' . $item->id); ?>"
									   title="<?php echo JText::_('JACTION_EDIT'); ?>">
										<?php echo $this->escape($item->vorname) . ' ' . $this->escape($item->name); ?></a>
								<?php else : ?>
									<span
										title="<?php echo JText::sprintf('JFIELD_ALIAS_LABEL', $this->escape($item->alias)); ?>"><?php echo $this->escape($item->vorname) . ' ' . $this->escape($item->name); ?></span>
								<?php endif; ?>
								<div class="small">
