...
/**
 * Weiterbildungen controller class.
 *
 * @package		Wissensmatrix.Administrator
 */
class WissensmatrixControllerWbig extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Wbig', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_wissensmatrix&view=wbigs'.$this->getRedirectToListAppend(), false));
