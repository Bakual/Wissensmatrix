    ...
    inherits: AmCharts.AmSlicedChart, construct: function () {
        ...
        if (AmCharts.ifArray(e)) {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.realHeight = h;
                var d = AmCharts.toCoordinate, k = d(this.marginLeft, a), b = d(this.marginRight, a), q = d(this.marginTop, h) + this.getTitleHeight(), l = d(this.marginBottom, h), w, x, f, s = AmCharts.toNumber(this.labelRadius), r = this.measureMaxLabel();
                ...
                l -= 90;
                a = f - f * this.angle / 90;
                for (k = 0; k < e.length; k++)if (b = e[k], !0 !== b.hidden && 0 < b.percents) {
                    var n = 360 * b.percents / 100, r = Math.sin((l + n / 2) / 180 * Math.PI), y = -Math.cos((l + n / 2) / 180 * Math.PI) * (a / f), p = {
                        fill: b.color,
        ...
        for (a = g - 1; 0 <= a; a--)c = e[a], 0 !== c.labelQuarter || c.hidden || this.checkOverlapping(a,
            c, 0, !0, 0);
        for (a = 0; a < g; a++)c = e[a], 1 != c.labelQuarter || c.hidden || this.checkOverlapping(a, c, 1, !1, 0);
        for (a = g - 1; 0 <= a; a--)c = e[a], 2 != c.labelQuarter || c.hidden || this.checkOverlapping(a, c, 2, !0, 0);
        for (a = 0; a < g; a++)c = e[a], 3 != c.labelQuarter || c.hidden || this.checkOverlapping(a, c, 3, !1, 0)
    }, checkOverlapping: function (e, g, c, a, h) {
        var d, k, b = this.chartData, q = b.length, l = g.label;
        if (l) {
            if (!0 === a)for (k = e + 1; k < q; k++)b[k].labelQuarter == c && (d = this.checkOverlappingReal(g, b[k], c)) && (k = q); else for (k = e - 1; 0 <= k; k--)b[k].labelQuarter ==
