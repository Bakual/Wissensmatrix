...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createRadarGraph: function () {
        ...
        if (a) {
            var c = {
                type: "clickGraphItem", item: a, index: a.index, graph: this,
        ...
        if (a) {
            ...
            if (this.drawingNow) {
                ...
                if (2 < Math.abs(c - d) || 2 < Math.abs(f - e))c = {
                    type: "draw", target: this, chart: a, initialX: c, initialY: f, finalX: d,
                    finalY: e
                }, this.fire(c.type, c)
            }
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < r && (r = 359.94);
    e >= r && (e = r);
    var s = 1 / 180 * Math.PI, r = b + Math.sin(d * s) * h, w = c - Math.cos(d * s) * q, v = b + Math.sin(d * s) * f, t = c - Math.cos(d * s) * g, A = b + Math.sin((d + e) * s) * f, E = c - Math.cos((d + e) * s) * g, x = b + Math.sin((d + e) * s) * h, s = c - Math.cos((d + e) * s) * q, z = {
