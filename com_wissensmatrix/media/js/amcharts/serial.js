AmCharts.AmSerialChart = AmCharts.Class({
    inherits: AmCharts.AmRectangularChart, construct: function () {
            ...
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                if (b.parseDates && !b.equalSpacing) {
                    if (b = this.startTime, c = this.endTime, isNaN(b) || isNaN(c))b = this.firstTime, c = this.lastTime
                        ...
                        this.start, c = this.end, isNaN(b) || isNaN(c))b = 0, c = a;
        ...
        isNaN(c) || (b != this.endTime && b - a > c &&
        (a = b - c, this.updateScrollbar = !0), a != this.startTime && b - a > c && (b = a + c, this.updateScrollbar = !0));
        ...
        var g = this.chartData, e = this.categoryAxis;
        if (AmCharts.ifArray(g) && (a != this.startTime || b != this.endTime)) {
            var k = e.minDuration(), d = this.firstTime, m = this.lastTime;
            a || (a = d, isNaN(c) || (a = m - c));
            b || (b = m);
            a > m && (a = m);
            b < d && (b = d);
            ...
            b > m && (b = m);
            b < a && (b = a + k);
            b - a < k / 5 && (b < m ? b = a + k / 5 : a = b - k / 5);
            this.startTime = a;
            this.endTime =
                b;
            c = g.length - 1;
            k = this.getClosestIndex(g, "time", a, !0, 0, c);
            g = this.getClosestIndex(g, "time", b, !1, k, c);
            e.timeZoom(a, b);
            e.zoom(k, g);
            this.start = AmCharts.fitToBounds(k, 0, c);
            this.end = AmCharts.fitToBounds(g, 0, c);
        ...
        var a = 0, b = this.valueAxes.length, c = this.graphs.length, d, e, g = !1, k, m;
        for (m = 0; m < b; m++) {
            e = this.valueAxes[m];
            var l = e.stackType;
            if ("100%" == l || "regular" == l)for (g = !1, k = 0; k < c; k++)d = this.graphs[k], d.hidden || d.valueAxis != e || "column" != d.type || (!g && d.stackable &&
            (a++, g = !0), !d.stackable && d.clustered && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
            if ("none" == l || "3d" == l)for (k = 0; k < c; k++)d = this.graphs[k], !d.hidden && d.valueAxis == e && "column" == d.type && d.clustered && (d.columnIndex = a, a++);
            if ("3d" == l) {
                for (m = 0; m < c; m++)d = this.graphs[m], d.depthCount = a;
                a = 1
            }
        }
        return a
    ...
    }, getClosestIndex: function (a, b, c, d, e, g) {
        0 > e && (e = 0);
        g > a.length - 1 && (g = a.length - 1);
        var k = e + Math.round((g - e) / 2), m = a[k][b];
        if (1 >= g - e) {
            if (d)return e;
            d = a[g][b];
            return Math.abs(a[e][b] - c) < Math.abs(d - c) ? e : g
        }
        return c == m ? k : c < m ? this.getClosestIndex(a, b, c, d, e, k) : this.getClosestIndex(a, b, c, d, k, g)
    ...
    zoomToCategoryValues: function (a, b) {
        ...
        if (b) {
            var c = ["value", "open", "low", "high", "close"], d = "value open low high close average sum count".split(" "), e = b.valueAxis, g = this.chartData, k = b.numberFormatter;
            k || (k = this.numberFormatter);
            for (var m = 0; m < c.length; m++) {
                for (var l = c[m], h = 0, f = 0, n, u, p, s, y, w = 0, r = 0, q, t, v, z, B, A = this.start; A <= this.end; A++) {
                    var x = g[A];
                ...
                w = {open: q, close: t, high: z, low: v, average: B, sum: w, count: r};
                a = AmCharts.formatValue(a, {
                    ...
                    sum: h,
                    count: f
                }, d, k, l + "\\.", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
        ...
        if (-1 != a.indexOf("[[category]]")) {
            ...
            if (this.categoryAxis.parseDates) {
                var e = this.balloonDateFormat, g = this.chartCursor;
                g && (e = g.categoryBalloonDateFormat);
        ...
        d = b.graph.valueAxis;
        (e = d.duration) && !isNaN(b.values.value) &&
        (d = AmCharts.formatDuration(b.values.value, e, "", d.durationUnits, d.maxInterval, c), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), d));
...
AmCharts.Cuboid = AmCharts.Class({
    construct: function (a, b, c, d, e, g, k, m, l, h, f, n, u, p, s) {
        this.set = a.set();
        this.container = a;
        this.h = Math.round(c);
        this.w = Math.round(b);
        ...
        this.dashLength = p;
        this.pattern = s;
        u ? 0 > b && 0 === f && (f = 180) : 0 > c && 270 == f && (f = 90);
        ...
        var a = this.set;
        a.clear();
        var b = this.container, c = this.w, d = this.h, e = this.dx, g =
            this.dy, k = this.colors, m = this.alpha, l = this.bwidth, h = this.bcolor, f = this.balpha, n = this.gradientRotation, u = this.cornerRadius, p = this.dashLength, s = this.pattern, y = k, w = k;
        "object" == typeof k && (y = k[0], w = k[k.length - 1]);
        var r, q, t, v, z, B, A, x, C;
        if (0 < e || 0 < g)A = w, w = AmCharts.adjustLuminosity(y, -0.2), w = AmCharts.adjustLuminosity(y, -0.2), r = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, g, g, 0, 0], w, m, 1, h, 0, n), 0 < f && (C = AmCharts.line(b, [0, e, c + e], [0, g, g], h, f, l, p)), q = AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], w, m, 1, h, 0, n), q.translate(e,
        ...
        1 > Math.abs(d) && (d = 0);
        1 > Math.abs(c) && (c = 0);
        b = 0 === d ? AmCharts.line(b, [0, c], [0, 0], h, f, l, p) : 0 === c ? AmCharts.line(b, [0,
            0], [0, d], h, f, l, p) : 0 < u ? AmCharts.rect(b, c, d, k, m, l, h, f, u, n, p) : AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], k, m, l, h, f, n, !1, p);
        d = 0 > d ? [r, C, q, t, v, z, B, A, x, b] : [A, x, q, t, v, z, r, C, B, b];
        for (r = 0; r < d.length; r++)(q = d[r]) && a.push(q);
        s && b.pattern(s)
    }, width: function (a) {
        this.w = a;
        this.draw()
...
AmCharts.CategoryAxis = AmCharts.Class({
    inherits: AmCharts.AxisBase, construct: function () {
        ...
        this.data = a;
        if (AmCharts.ifArray(a)) {
            var b, c = this.chart, d = this.start, e = this.labelFrequency, g = 0;
            b = this.end - d + 1;
            var k = this.gridCount, m = this.showFirstLabel, l = this.showLastLabel, h, f = "", n = AmCharts.extractPeriod(this.minPeriod);
            h = AmCharts.getPeriodDuration(n.period, n.count);
            var u, p, s, y, w;
            u = this.rotate;
            var r = this.firstDayOfWeek, q = this.boldPeriodBeginning, a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * h), this.minPeriod, 1, r).getTime(), t;
            this.endTime >
            a && (this.endTime = a);
            t = this.minorGridEnabled;
            var v, a = this.gridAlpha, z;
            if (this.parseDates && !this.equalSpacing) {
                this.timeDifference = this.endTime - this.startTime;
                d = this.choosePeriod(0);
                e = d.period;
                u = d.count;
                p = AmCharts.getPeriodDuration(e, u);
                p < h && (e = n.period, u = n.count, p = h);
                s = e;
                "WW" == s && (s = "DD");
                this.stepWidth = this.getStepWidth(this.timeDifference);
                var k = Math.ceil(this.timeDifference / p) + 5, B = f = AmCharts.resetDateToMin(new Date(this.startTime - p), e, u, r).getTime();
                s == e && 1 == u && this.centerLabelOnFullPeriod && (y =
                    p * this.stepWidth);
                this.cellWidth = h * this.stepWidth;
                b = Math.round(f / p);
                d = -1;
                b / 2 == Math.round(b / 2) && (d = -2, f -= p);
                var A = c.firstTime, x = 0;
                t && 1 < u && (v = this.chooseMinorFrequency(u), z = AmCharts.getPeriodDuration(e, v));
                if (0 < this.gridCount)for (b = d; b <= k; b++) {
                    n = A + p * (b + Math.floor((B - A) / p)) - x;
                    n = AmCharts.resetDateToMin(new Date(n), e, u, r).getTime();
                    "MM" == e && (t = (n - f) / p, 1.5 <= (n - f) / p && (n -= (t - 1) * p, x += p));
                    h = (n - this.startTime) * this.stepWidth;
                    w = !1;
                    this.nextPeriod[s] && (w = this.checkPeriodChange(this.nextPeriod[s], 1, n, f));
                    t = !1;
                    w && this.markPeriodChange ? (f = this.dateFormatsObject[this.nextPeriod[s]], t = !0) : f = this.dateFormatsObject[s];
                    q || (t = !1);
                    f = AmCharts.formatDate(new Date(n), f);
                    if (b == d && !m || b == k && !l)f = " ";
                    this.labelFunction && (f = this.labelFunction(f, new Date(n), this));
                    f = new this.axisItemRenderer(this, h, f, !1, y, 0, !1, t);
                    this.pushAxisItem(f);
                    f = n;
                    if (!isNaN(v))for (h = 1; h < u; h += v)this.gridAlpha = this.minorGridAlpha, t = n + z * h, t = AmCharts.resetDateToMin(new Date(t), e, v, r).getTime(), t = new this.axisItemRenderer(this, (t - this.startTime) * this.stepWidth),
                        this.pushAxisItem(t);
                    this.gridAlpha = a
                }
            } else if (!this.parseDates) {
                if (this.cellWidth = this.getStepWidth(b), b < k && (k = b), g += this.start, this.stepWidth = this.getStepWidth(b), 0 < k)for (q = Math.floor(b / k), v = this.chooseMinorFrequency(q), h = g, h / 2 == Math.round(h / 2) && h--, 0 > h && (h = 0), k = 0, b = h; b <= this.end + 2; b++) {
                    r = !1;
                    0 <= b && b < this.data.length ? (s = this.data[b], f = s.category, r = s.forceShow) : f = "";
                    if (t && !isNaN(v))if (b / v == Math.round(b / v) || r)b / q == Math.round(b / q) || r || (this.gridAlpha = this.minorGridAlpha, f = void 0); else continue; else if (b /
                        q != Math.round(b / q) && !r)continue;
                    h = this.getCoordinate(b - g);
                    r = 0;
                    "start" == this.gridPosition && (h -= this.cellWidth / 2, r = this.cellWidth / 2);
                    if (b == d && !m || b == this.end && !l)f = void 0;
                    Math.round(k / e) != k / e && (f = void 0);
                    k++;
                    B = this.cellWidth;
                    u && (B = NaN);
                    this.labelFunction && s && (f = this.labelFunction(f, s, this));
                    f = AmCharts.fixNewLines(f);
                    f = new this.axisItemRenderer(this, h, f, !0, B, r, void 0, !1, r);
                    this.pushAxisItem(f);
                    this.gridAlpha = a
                }
                ...
                k = Math.ceil(this.timeDifference / p) + 1;
                f = AmCharts.resetDateToMin(new Date(this.startTime - p), e, u, r).getTime();
                ...
                0 > h && (h =
                    0);
                y = this.end + 2;
                y >= this.data.length && (y = this.data.length);
                z = !1;
                z = !m;
                this.previousPos = -1E3;
                20 < this.labelRotation && (this.safeDistance = 5);
                p = h;
                if (this.data[h].time != AmCharts.resetDateToMin(new Date(this.data[h].time), e, u, r).getTime())for (r = 0, A = f, b = h; b < y; b++)n = this.data[b].time, this.checkPeriodChange(e, u, n, A) && (r++, 2 <= r && (p = b, b = y), A = n);
                t && 1 < u && (v = this.chooseMinorFrequency(u), AmCharts.getPeriodDuration(e, v));
                for (b = h; b < y; b++)if (n = this.data[b].time, this.checkPeriodChange(e, u, n, f) && b >= p) {
                    h = this.getCoordinate(b -
                        this.start);
                    w = !1;
                    this.nextPeriod[s] && (w = this.checkPeriodChange(this.nextPeriod[s], 1, n, f));
                    t = !1;
                    ...
                    f = AmCharts.formatDate(new Date(n), f);
                    if (b == d && !m || b == k && !l)f = " ";
                    z ? z = !1 : (q || (t = !1), h - this.previousPos > this.safeDistance * Math.cos(this.labelRotation * Math.PI / 180) && (this.labelFunction && (f = this.labelFunction(f, new Date(n), this)), f = new this.axisItemRenderer(this, h, f, void 0, void 0, void 0, void 0, t), r = f.graphics(),
                        this.pushAxisItem(f), r = r.getBBox().width, AmCharts.isModern || (r -= h), this.previousPos = h + r));
                    f = n
                } else isNaN(v) || (this.checkPeriodChange(e, v, n, B) && (this.gridAlpha = this.minorGridAlpha, h = this.getCoordinate(b - this.start), t = new this.axisItemRenderer(this, h), this.pushAxisItem(t), B = n), this.gridAlpha = a)
            }
            for (b = 0; b < this.data.length; b++)if (m = this.data[b])l = this.parseDates && !this.equalSpacing ? Math.round((m.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - g), m.x[this.id] = l;
            ...
            for (b = 0; b < m; b++)l = this.guides[b], q = q = q = a = d = NaN, v = l.above, l.toCategory && (q = c.getCategoryIndexByValue(l.toCategory), isNaN(q) || (d = this.getCoordinate(q - g), f = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(f, v))), l.category && (q = c.getCategoryIndexByValue(l.category), isNaN(q) || (a = this.getCoordinate(q - g), q = (d - a) / 2, f = new this.axisItemRenderer(this, a, l.label, !0, NaN, q, l), this.pushAxisItem(f, v))), l.toDate && (this.equalSpacing ? (q = c.getClosestIndex(this.data, "time", l.toDate.getTime(), !1, 0, this.data.length -
                ...
                NaN, q, l), this.pushAxisItem(f, v)), d = new this.guideFillRenderer(this, a, d, l), a = d.graphics(), this.pushAxisItem(d, v), l.graphics = a, a.index = b, l.balloonText && this.addEventListeners(a, l)
        }
        this.axisCreated = !0;
        c = this.x;
        g = this.y;
        this.set.translate(c, g);
        this.labelsSet.translate(c, g);
        this.positionTitle();
        ...
        var b = AmCharts.getPeriodDuration(this.periods[a].period, this.periods[a].count),
            c = Math.ceil(this.timeDifference / b), d = this.periods;
        ...
        c = new Date(c);
        var e = new Date(d), g = this.firstDayOfWeek;
        d = b;
        "DD" == a && (b = 1);
        c = AmCharts.resetDateToMin(c, a, b, g).getTime();
        b = AmCharts.resetDateToMin(e, a, b, g).getTime();
        ...
        var c = AmCharts.fitToBounds(c, 0, b.length - 1), g;
        b[c] && (g = b[c].x[this.id]);
        d ? g > this.height + 1 && c-- : g > this.width + 1 && c--;
        0 > g && c++;
