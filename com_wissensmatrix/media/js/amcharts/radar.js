...
AmCharts.RadAxis = AmCharts.Class({
    construct: function (a) {
        ...
        if (b) {
            ...
            var w = a.length, r;
            for (r = 0; r < w; r++) {
                var g = 180 - 360 / w * r, p = n + this.axisWidth * Math.sin(g / 180 * Math.PI), s = e + this.axisWidth * Math.cos(g /
                        180 * Math.PI);
...
AmCharts.RadItem = AmCharts.Class({
    construct: function (a, b, c, d, m, n, e) {
        ...
        n = a.x;
        var E = a.y;
        e ? (B = !0, isNaN(e.tickLength) ||
        (r = e.tickLength), void 0 != e.lineColor && (s = e.lineColor), isNaN(e.lineAlpha) || (g = e.lineAlpha), isNaN(e.dashLength) || (u = e.dashLength), isNaN(e.lineThickness) || (p = e.lineThickness), !0 === e.inside && (C = !0)) : c || (g /= 3, r /= 2);
        var F = "end", z = -1;
        C && (F = "start", z = 1);
        var v;
        ...
        if (0 < g) {
            if ("polygons" == D) {
                t = a.data.length;
                for (l = 0; l < t; l++)q = 180 - 360 / t * l, f.push(b * Math.sin(q /
                        180 * Math.PI)), k.push(b * Math.cos(q / 180 * Math.PI));
                f.push(f[0]);
                k.push(k[0]);
                g = AmCharts.line(h, f, k, s, g, p, u)
            } else g = AmCharts.circle(h, b, "#FFFFFF", 0, p, s, g);
            g.translate(n, E);
            d.push(g)
        }
        if (1 == m && 0 < y && !e && "" !== c) {
            e = a.previousCoord;
            if ("polygons" == D) {
                for (l = t; 0 <= l; l--)q = 180 - 360 / t * l, f.push(e * Math.sin(q / 180 * Math.PI)), k.push(e * Math.cos(q / 180 * Math.PI));
                t = AmCharts.polygon(h, f, k, A, y)
            } else t = AmCharts.wedge(h, 0, 0, 0, 360, b, b, e, 0, {
                fill: A,
                "fill-opacity": y,
                stroke: "#000",
                "stroke-opacity": 0,
...
AmCharts.RadarFill = AmCharts.Class({
    construct: function (a, b, c, d) {
        ...
        if ("polygons" == a.gridType) {
            ...
            for (h = 0; h < l; h++)f = 180 - 360 / l * h, d.push(m * Math.sin(f / 180 * Math.PI)),
                k.push(m * Math.cos(f / 180 * Math.PI));
            d.push(d[0]);
            k.push(k[0]);
            for (h = l; 0 <= h; h--)f = 180 - 360 / l * h, d.push(b * Math.sin(f / 180 * Math.PI)), k.push(b * Math.cos(f / 180 * Math.PI));
