AmCharts.AmXYChart = AmCharts.Class({
    inherits: AmCharts.AmRectangularChart, construct: function () {
        ...
        var a = this.marginLeftReal,
            c = this.marginTopReal, b = this.plotAreaWidth, d = this.plotAreaHeight;
        ...
        0 === c.length && (d = new AmCharts.ValueAxis, d.rotate = !1, d.setOrientation(!1), b.push(d),
            c.push(d));
        0 === a.length && (d = new AmCharts.ValueAxis, d.rotate = !0, d.setOrientation(!0), b.push(d), a.push(d));
        ...
        for (c = 0; c < a.length; c++) {
            ...
            if (!isNaN(b.min) && !isNaN(b.max)) {
                var d, e;
                "V" == b.orientation ? (d = b.coordinateToValue(-this.verticalPosition), e = b.coordinateToValue(-this.verticalPosition + this.plotAreaHeight)) : (d = b.coordinateToValue(-this.horizontalPosition), e = b.coordinateToValue(-this.horizontalPosition +
                    this.plotAreaWidth));
                if (!isNaN(d) && !isNaN(e)) {
                    if (d > e) {
                        var f = e;
        ...
        this.parseData();
        var a = this.chartData, c = a.length - 1, b = this.graphs, d = this.dataProvider, e = 0, f, g;
        for (f = 0; f < b.length; f++)if (g = b[f], g.data = a, g.zoom(0, c), g = g.valueField) {
            var k;
        ...
        for (f = 0; f < b.length; f++)g = b[f], g.maxValue =
            e;
    ...
    }, formatString: function (a, c) {
        var b = c.graph.numberFormatter;
        b || (b = this.numberFormatter);
        a = AmCharts.formatValue(a, c.values, ["value", "x", "y"], b);
        -1 != a.indexOf("[[") && (a = AmCharts.formatDataContextValue(a, c.dataContext));
        return a = AmCharts.AmXYChart.base.formatString.call(this, a, c)
        ...
        if (a) {
            ...
            this.hideXScrollbar || (b = new AmCharts.SimpleChartScrollbar,
                b.skipEvent = !0, b.chart = this, this.listenTo(b, "zoomed", this.handleHSBZoom), AmCharts.copyProperties(a, b, c), b.rotate = !1, this.scrollbarH = b)
        }
        ...
        var c = this.widthMultiplier *
            this.plotAreaWidth / a.selectionWidth, b = this.heightMultiplier * this.plotAreaHeight / a.selectionHeight, c = this.fitMultiplier(c), b = this.fitMultiplier(b);
