 ...
 */
class WissensmatrixControllerZwbi extends JControllerForm
{
	/**
	 * @since    1.6
	 */
	protected $view_item = 'zwbiform';
	 ...
	 * @since    1.5
	 */
	public function getModel($name = 'zwbiform', $prefix = '', $config = array('ignore_request' => true))
	{
