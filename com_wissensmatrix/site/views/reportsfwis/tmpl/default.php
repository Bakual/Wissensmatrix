				...
				<div id="filter-bar" class="filters btn-toolbar">
					<?php if ($this->params->get('filter_field')) : ?>
						...
						<div class="btn-group filter-select input-append">
							...
							<?php if ($this->parent) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportsfwis&teamid=' . $this->parent->id); ?>"
								   class="btn addon"
				...
				<table class="table table-striped table-hover table-condensed">
					...
					<?php foreach ($this->items as $i => $item) : ?>
						<tr class="<?php echo ($item->state) ? '' : 'system-unpublished '; ?>cat-list-row<?php echo $i % 2; ?>">
							<td class="title">
								<span
									title="<?php echo JText::_('COM_WISSENSMATRIX_FWIG') . ': ' . $item->fwig_title; ?>"
