...
?>
<div class="category-list<?php echo $this->pageclass_sfx;?> wm-reportswbigs-container<?php echo $this->pageclass_sfx; ?>">
				...
				<div id="filter-bar" class="filters btn-toolbar">
					<?php if ($this->params->get('filter_field')) : ?>
						...
						<div class="btn-group filter-select input-append">
							...
							<?php if ($this->parent) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportswbigs&teamid='.$this->parent->id); ?>" class="btn addon" title="<?php JText::printf('COM_WISSENSMATRIX_GET_PARENT_TEAM', $this->parent->title); ?>" rel="tooltip"><i class="icon-arrow-up"></i></a>
							<?php endif; ?>
						</div>
					<?php endif;
				...
				<!-- Begin Data -->
					<tbody>
						...
						<tr class="info">
							...
							<td class="reports">
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportwbigsummary'); ?>"><img src="media/com_wissensmatrix/images/black_view.gif"></a>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportwbigsummary&format=xls'); ?>"><img src="media/com_wissensmatrix/images/icon_download.gif"></a>
							</td>
						</tr>
					</tbody>
				</table>
