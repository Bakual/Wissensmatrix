...
?>
<div
	class="category-list<?php echo $this->pageclass_sfx; ?> wm-reportsfwigs-container<?php echo $this->pageclass_sfx; ?>">
					...
					<?php if ($this->params->get('filter_field')) : ?>
						<div class="filter-search btn-group input-append pull-left">
							...
							<button class="btn tip hidden-phone hidden-tablet" type="button"
									onclick="document.id('filter-search').value='';this.form.submit();" rel="tooltip"
						...
						<div class="btn-group filter-select input-append">
							...
							<?php if ($this->parent) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportsfwigs&teamid=' . $this->parent->id); ?>"
								   class="btn addon"
				...
				<table class="table table-striped table-hover table-condensed">
					...
					<?php foreach ($this->items as $i => $item) : ?>
						<tr class="<?php echo ($item->state) ? '' : 'system-unpublished '; ?>cat-list-row<?php echo $i % 2; ?>">
							...
							<td class="reports">
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwigteam&id=' . $item->id); ?>"><img
										src="media/com_wissensmatrix/images/black_view.gif"></a>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwigteam&format=xls&id=' . $item->id); ?>"><img
										src="media/com_wissensmatrix/images/icon_download.gif"></a>
							</td>
							<td class="reports">
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwiglevels&id=' . $item->id); ?>"><img
										src="media/com_wissensmatrix/images/black_view.gif"></a>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwiglevels&format=xls&id=' . $item->id); ?>"><img
										src="media/com_wissensmatrix/images/icon_download.gif"></a>
							</td>
							<td class="reports">
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwigdiff&id=' . $item->id); ?>"><img
										src="media/com_wissensmatrix/images/black_view.gif"></a>
								<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwigdiff&format=xls&id=' . $item->id); ?>"><img
										src="media/com_wissensmatrix/images/icon_download.gif"></a>
							</td>
						</tr>
					<?php endforeach; ?>
					<tr class="info">
						...
						<td class="reports">
							<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwiglevelssummary'); ?>"><img
									src="media/com_wissensmatrix/images/black_view.gif"></a>
							<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwiglevelssummary&format=xls'); ?>"><img
									src="media/com_wissensmatrix/images/icon_download.gif"></a>
						</td>
						<td class="reports">
							<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwigdiffsummary'); ?>"><img
									src="media/com_wissensmatrix/images/black_view.gif"></a>
							<a href="<?php echo JRoute::_('index.php?option=com_wissensmatrix&view=reportfwigdiffsummary&format=xls'); ?>"><img
									src="media/com_wissensmatrix/images/icon_download.gif"></a>
						</td>
					</tr>
					</tbody>
