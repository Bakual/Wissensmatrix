...
class WissensmatrixViewWorker extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		{
			$app->redirect(JRoute::_('index.php?view=workers'), JText::_('JGLOBAL_RESOURCE_NOT_FOUND'), 'error');
		}
		...
		if ($this->item->category_access)
		{
			...
			{
				$app->redirect(JRoute::_('index.php?view=workers'), JText::_('JERROR_ALERTNOAUTHOR'), 'error');
			}
		}
